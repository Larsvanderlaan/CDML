...
for(lrnr in c("all")) {
  for(misp in c("Both", "Treatment", "Outcome" )) {
    ...
    )  + labs(x = "Sample Size (n)", y = "Coverage", color = "Estimator", group = "Estimator", shape= "Estimator")   + scale_y_log10(breaks = c(1, 0.97, 0.95, 0.93, 0.91, 0.9, 0.8, 0.6, 0.4)) + geom_hline(yintercept = 0.95, color = "black")
